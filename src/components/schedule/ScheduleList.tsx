...
import { CalendarIcon, LocationMarkerIcon, UsersIcon, VideoCameraIcon } from "@heroicons/react/solid";
            ...
            {!schedule.length ? (
                <div className="overflow-hidden rounded-lg mx-2 my-4 p-4">
                    <div className="w-full bg-blue-200 text-center rounded-lg px-4 py-6">
                        <h1 className="text-blue-800 text-sm font-bold">
                ...
                <div>
                    {schedule.map((x, idx: number) => (
                        <div className="border-2 rounded-md mx-2 my-6">
                            <div key={`scheduleList ${idx}`}>
                                <div className="p-3">
